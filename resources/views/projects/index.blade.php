    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="hidden lg:block lg:w-1/4">
            <div class="bg-white rounded-lg shadow-sm p-4 mb-4">
                <h3 class="font-semibold text-lg mb-3">Kısayollar</h3>
                <div class="space-y-2">
            ...
            <div class="bg-white rounded-lg shadow-sm p-4">
                <h3 class="font-semibold text-lg mb-3">Takip Ettiğin Topluluklar</h3>
                <div class="space-y-3">
                    <a href="#" class="flex items-center space-x-3 group">
                        ...
                        <div class="flex-1">
                            <h4 class="font-medium group-hover:text-blue-600">Web Developers</h4>
                            <p class="text-xs text-gray-500">12.5k üye</p>
                        </div>
                    ...
                    <a href="#" class="flex items-center space-x-3 group">
                        ...
                        <div class="flex-1">
                            <h4 class="font-medium group-hover:text-blue-600">Freelance Dünyası</h4>
                            <p class="text-xs text-gray-500">8.2k üye</p>
                        </div>
                        <button class="text-blue-500 hover:text-blue-700">
                            <i class="fas fa-ellipsis-h"></i>
                        </button>
                    ...
                    <a href="#" class="flex items-center space-x-3 group">
                        ...
                        <div class="flex-1">
                            <h4 class="font-medium group-hover:text-blue-600">JavaScript Türkiye</h4>
                            <p class="text-xs text-gray-500">5.7k üye</p>
                        </div>
                        <button class="text-blue-500 hover:text-blue-700">
                            <i class="fas fa-ellipsis-h"></i>
                        </button>
                ...
                <div class="space-y-4">
                    <div class="border border-blue-200 rounded-lg p-4 bg-blue-50 hover:bg-blue-100 transition-colors cursor-pointer">
                        <div class="flex items-start justify-between mb-2">
                            <h3 class="font-medium text-gray-800">React.js ile E-ticaret Sitesi</h3>
                            <span class="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full font-medium">₺15,000 - ₺25,000</span>
                        </div>
                        <p class="text-gray-600 text-sm mb-3">Modern bir e-ticaret platformu geliştirmek istiyoruz. React.js, Node.js ve MongoDB kullanılacak...</p>
                    ...
                    <div class="border border-blue-200 rounded-lg p-4 bg-blue-50 hover:bg-blue-100 transition-colors cursor-pointer">
                        <div class="flex items-start justify-between mb-2">
                            <h3 class="font-medium text-gray-800">Mobil Uygulama UI/UX Tasarımı</h3>
                            <span class="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full font-medium">₺8,000 - ₺12,000</span>
                        </div>
                        <p class="text-gray-600 text-sm mb-3">Fitness uygulaması için modern ve kullanıcı dostu arayüz tasarımı yapılacak...</p>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4 text-xs text-gray-500">
                ...
                <div class="space-y-4">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex-1">
                                <h3 class="font-medium text-gray-800 mb-1">Laravel ile CRM Sistemi Geliştirme</h3>
                                ...
                                <p class="text-gray-600 text-sm mb-3">Şirketimiz için kapsamlı bir CRM sistemi geliştirmek istiyoruz. Laravel framework kullanılacak, modern arayüz ve raporlama modülleri olacak...</p>
                                <div class="flex items-center space-x-2 mb-2">
                                    <span class="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">Laravel</span>
                                    <span class="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">MySQL</span>
                                    <span class="bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full">Vue.js</span>
                                </div>
                            </div>
                            <div class="text-right ml-4">
                                <span class="bg-green-100 text-green-800 text-sm px-3 py-1 rounded-full font-medium">₺20,000 - ₺35,000</span>
        ...
        <div class="w-full lg:w-1/4">
            <!-- Quick Stats -->
            <div class="bg-white rounded-lg shadow-sm p-4 mb-4">
                <h3 class="font-semibold text-lg mb-3">İstatistikler</h3>
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        <span class="text-gray-600">Aktif Projeler</span>
                        <span class="font-semibold text-blue-600">1,247</span>
                    </div>
                    <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-gray-600">Ortalama Bütçe</span>
                        <span class="font-semibold text-purple-600">₺12,500</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Top Categories -->
            <div class="bg-white rounded-lg shadow-sm p-4 mb-4">
                <h3 class="font-semibold text-lg mb-3">Popüler Kategoriler</h3>
                <div class="space-y-2">
                    <a href="#" class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50">
                        ...
                        <span class="text-xs bg-gray-100 px-2 py-1 rounded-full">324</span>
                    </a>
                    <a href="#" class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50">
                        <div class="flex items-center space-x-2">
                        ...
                        <span class="text-xs bg-gray-100 px-2 py-1 rounded-full">198</span>
                    </a>
                    <a href="#" class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50">
                        <div class="flex items-center space-x-2">
                        ...
                        <span class="text-xs bg-gray-100 px-2 py-1 rounded-full">156</span>
                    </a>
                    <a href="#" class="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50">
                        <div class="flex items-center space-x-2">
                        ...
                        <span class="text-xs bg-gray-100 px-2 py-1 rounded-full">89</span>
                    </a>
                </div>
            </div>
            ...
            <!-- Recent Activity -->
            <div class="bg-white rounded-lg shadow-sm p-4">
                <h3 class="font-semibold text-lg mb-3">Son Aktiviteler</h3>
                <div class="space-y-3">
                    <div class="flex items-start space-x-3">
                        <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="User" class="w-8 h-8 rounded-full">
                        <div class="flex-1">
                            <p class="text-sm"><span class="font-medium">Ayşe K.</span> yeni bir proje ekledi</p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm"><span class="font-medium">Mehmet Y.</span> bir projeye teklif verdi</p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm"><span class="font-medium">Zeynep A.</span> projesini tamamladı</p>
